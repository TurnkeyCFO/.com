(function () {
  ...
  track('lp_view', { lp: 'hairsalon', lp_version: 'v1' });
  ...
  function depth() {
    ...
    [25, 50, 75, 90].forEach(function (t) {
      if (pct >= t && !fired[t]) {
        fired[t] = true;
        track('scroll_depth', { depth: t, lp: 'hairsalon' });
      }
    });
  }
